...
def list_dock_by_id(id,count):
	url = "https://mercury.vtexcommercestable.com.br/api/logistics/pvt/configuration/docks/"+str(id)+""
...
def cargando_bigquery(count,result):
	try:
		...
		client = bigquery.Client()
		filename = '/home/bred_valenzuela/full_vtex/vtex/logistics_api/DOCKS/temp.json'
		dataset_id = 'landing_zone'
		table_id = 'shopstar_vtex_list_dock_by_id'
...
def operacion_fenix(count):
	f_01 = open ('/home/bred_valenzuela/full_vtex/vtex/logistics_api/DOCKS/id_dock.json','r')
