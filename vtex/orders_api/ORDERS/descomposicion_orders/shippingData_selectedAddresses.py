...
def delete_duplicate():
  try:
    ...
    QUERY = ('CREATE OR REPLACE TABLE `shopstar-datalake.test.shippingData_selectedAddresses` AS SELECT DISTINCT * FROM `shopstar-datalake.test.shippingData_selectedAddresses`')
