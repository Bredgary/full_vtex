...
def delete_duplicate():
  try:
    ...
    QUERY = ('CREATE OR REPLACE TABLE `shopstar-datalake.test.shippingData_logisticsInfo_pickupStoreInfo` AS SELECT DISTINCT * FROM `shopstar-datalake.test.shippingData_logisticsInfo_pickupStoreInfo`')
...
def run():
    try:
        ...
        table_id = 'shippingData_logisticsInfo_pickupStoreInfo'
