...
def cl_client():
	...
	querystring = {"_fields":"id,firstName,lastName,email,accountId,accountName,dataEntityId","_where":"createdIn="+format+""}
	headers = {
...
columns=['id','firstName','lastName','email','accountId','accountName','dataEntityId'])
