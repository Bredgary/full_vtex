...
def delete_duplicate():
	try:
		...
		QUERY = (
			'CREATE OR REPLACE TABLE `shopstar-datalake.staging_zone.shopstar_vtex_client_1` AS SELECT DISTINCT * FROM `shopstar-datalake.staging_zone.shopstar_vtex_client_1`')
