...
def cargando_bigquery():
	...
	system("cat items.json | jq -c '.[]' > table_list_task.json")
	client = bigquery.Client()
	filename = '/home/bred_valenzuela/full_vtex/vtex/vtex_do_api/TASK/table_list_task.json'
	dataset_id = 'landing_zone'
	table_id = 'shopstar_vtex_list_task'
