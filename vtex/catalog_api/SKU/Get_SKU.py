...
def get_productID(idSKU):
	url = "https://mercury.vtexcommercestable.com.br/api/catalog/pvt/stockkeepingunit/"+str(idSKU)+""
...
def get_params():
	...
	for row in rows:
		init.SKUList.append(row.id)
	for x in init.SKUList:
		init.FROM = 0
		init.TO = 50
