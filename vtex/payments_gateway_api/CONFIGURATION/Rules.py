...
def rules():
	url = "https://mercury.vtexpayments.com.br/api/pvt/rules"
...
def cargando_bigquery():
	...
	system("cat items.json | jq -c '.[]' > rules.json")
	client = bigquery.Client()
	filename = '/home/bred_valenzuela/full_vtex/vtex/payments_gateway_api/CONFIGURATION/rules.json'
	dataset_id = 'landing_zone'
	table_id = 'shopstar_vtex_rules'
