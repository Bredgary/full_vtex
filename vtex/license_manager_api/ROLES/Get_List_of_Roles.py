...
url = "https://mercury.vtexcommercestable.com.br/api/license-manager/site/pvt/roles/list/paged"
querystring = {"numItems":"23","pageNumber":"1","sort":"id","sortType":"ASC"}
...
def get_user(start,headers,total):
	try:
		...
		text_file = open("/home/bred_valenzuela/full_vtex/vtex/license_manager_api/ROLES/items.json", "w")
